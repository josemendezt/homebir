...
const sheetVariants = cva('fixed z-50 scale-100 gap-4 bg-white bg-opacity-90  p-6  shadow-lg border overflow-auto max-w-[620px] sm:min-w-full', {
  variants: {
    position: {
...
>(({ className, ...props }, ref) => <SheetPrimitive.Description ref={ref} className={cn('text-sm', className)} {...props} />)
