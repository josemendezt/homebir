...
const CameraMenu = React.memo(
  ({ isEnabled }: { isEnabled: boolean }) => {
    const { initializeCamera, cameraPosition, setCameraPosition } =
      useCameraPosition();
    ...
    const initialPosition =
      width > 1023 ? new THREE.Vector3(3, 14, 12) : smPositions; // Posición inicial desde arriba
